...
import { CliLoopbackRedirectUriSchema } from '../src/lib/types/cliAuth.js';
import type { CliCallbackListener } from '../src/lib/types/cliAuth.js';
...
describe('strict CLI loopback callback URLs', (): void => {
  it.each([
    'http://127.0.0.1:1/callback',
    'http://127.0.0.1:49152/callback',
    'http://127.0.0.1:65535/callback',
  ])('accepts %s', (url: string): void => {
  ...
  it.each([
    ...
    ' http://127.0.0.1:5000/callback',
  ])('rejects normalized or non-loopback spelling %s', (url: string): void => {
