...
import type { TranscriptDetector } from '@lib/services/analysis/transcript/detector.js';
import type {
  TranscriptLine,
  MicroBlock,
  LLMChunk,
...
vi.mock('@lib/services/analysis/llm/index.js', () => ({
  analyzeChunks: vi.fn(),
}));

vi.mock('@lib/services/analysis/refiner/index.js', () => ({
