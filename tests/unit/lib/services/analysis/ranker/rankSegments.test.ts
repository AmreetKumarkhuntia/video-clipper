...
import { rankSegments } from '@lib/services/analysis/ranker/index.js';
import type { MergedCandidate } from '@lib/types/index.js';
...
describe('rankSegments', () => {
  ...
  it('keeps segments exactly at the inclusive threshold', () => {
