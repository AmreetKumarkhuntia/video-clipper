...
import ConfigSection from '../src/app/web/widgets/settings/ConfigSection.svelte';
import type { ConfigFieldDescriptor, ConfigGroupDescriptor } from '../src/lib/types/config.js';
