...
Results are persisted to the library database: re-run "vdclip clip <analysis-id>"
...
Examples:
  ...
  vdclip run https://youtube.com/watch?v=dQw4w9WgXcQ --local-video /path/to/video.mp4 --top-n 5
