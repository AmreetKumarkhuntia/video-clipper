        ...
        <aside className="rail">
          ...
          <div className="rail__group">
            <div className="rail__row">
              ...
              <span className="val val--accent">9 / 10</span>
            </div>
            <div className="rail__row">
              <span className="label">Start</span>
              <span className="val">02:14.180</span>
            </div>
            <div className="rail__row">
              <span className="label">End</span>
              <span className="val">02:48.420</span>
            </div>
            <div className="rail__row">
              <span className="label">Duration</span>
              <span className="val">34.24s</span>
            </div>
            <div className="rail__row">
            ...
            <div className="rail__row">
              ...
              <span className="val val--ok">cut · 02</span>
            </div>
          </div>
          ...
          <div className="reasons">
            <div className="reason">
              <span className="reason__k">Transcript</span>
              <span className="reason__v">Strong claim, controversial framing.</span>
            </div>
            <div className="reason">
              <span className="reason__k">Audio</span>
              <span className="reason__v">Crowd murmur at 02:46.</span>
            </div>
            <div className="reason">
              <span className="reason__k">Pacing</span>
              <span className="reason__v">Single thought, lands cleanly.</span>
            </div>
          </div>
        ...
        <div className="main main--detail">
          ...
          <div className="player player--detail">
            ...
            <div className="player__caption">
              "You can't ship great products and protect every legacy interface."
            </div>
          </div>
          ...
          <div className="wave">
            ...
            <div className="wave__track">
              <div className="wave__bars">
                {bars.map((h, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`wave__bar ${inSel ? 'is-sel' : ''}`}
                      style={{ height: `${h * 100}%` }}
                    ></div>
                  );
                })}
              ...
              <div className="wave__sel" style={{ left: '20%', right: '25%' }}>
                <div className="wave__handle wave__handle--l">
                  <span></span>
                </div>
                <div className="wave__handle wave__handle--r">
                  <span></span>
                </div>
              </div>
          ...
          <div className="sect">
            ...
            <div className="transcript">
              <p className="transcript__line transcript__line--out">
                <span className="transcript__t">02:08</span>And so this is where I think people get
                it wrong. They look at backwards compatibility…
              </p>
              <p className="transcript__line transcript__line--in">
                <span className="transcript__t">02:14</span>
                <strong>
                  You can't ship great products and protect every legacy interface.
                </strong>{' '}
                You have to choose.
              ...
              <p className="transcript__line transcript__line--in">
                <span className="transcript__t">02:24</span>Every API surface you keep is a tax on
                the next decision. It compounds. By year three you're not building a product, you're
                maintaining a museum.
              </p>
              <p className="transcript__line transcript__line--in">
                <span className="transcript__t">02:38</span>The companies that ship — and I mean
                really ship — break things on purpose. They version aggressively. They tell users
                no.
              </p>
              <p className="transcript__line transcript__line--out">
                <span className="transcript__t">02:48</span>Now, that's not the same as being
                careless…
              </p>
            </div>
          </div>
        ...
        <aside className="side">
          ...
          <div className="side__group">
            <textarea
              ...
              style={{ fontFamily: 'var(--vc-font-body)', minHeight: 64 }}
              defaultValue="You can't ship great products and protect every legacy interface."
            ></textarea>
          </div>
