          ...
          steps={[
            {
              ...
              state: 'pending',
              detail: 'yt-dlp · youtube-transcript-api',
            },
        ...
        <div className="empty">
          <div className="empty__glyph">
            <span className="vc-wordmark" style={{ fontSize: 56, letterSpacing: '-0.03em' }}>
              Video Clipper
              <span
                className="vc-wordmark__dot"
                style={{ width: 14, height: 14, marginLeft: 8 }}
              ></span>
            </span>
          </div>
          <p className="empty__lede">
            Paste a YouTube URL to begin. We'll fetch the transcript, score chunks with an LLM, and
          ...
          <div className="empty__url">
            <div className="vc-input-wrap" style={{ flex: 1 }}>
              <Icons.Link />
              <input
                className="vc-input vc-input--with-icon vc-input--lg"
                placeholder="https://youtube.com/watch?v=…"
                autoFocus
              />
            </div>
            <button className="vc-btn vc-btn--primary vc-btn--lg">
              <Icons.Sparkles />
              Analyze
            </button>
          </div>
              ...
              {[
                {
                  ...
                  chan: 'Stripe Press · 30:23',
                  segs: 10,
                  score: '9 · 8 · 8',
                  when: '2h ago',
                },
                {
                  title: 'What we learned shipping Claude Code to a million developers',
                  chan: 'Anthropic · 48:11',
                  segs: 12,
                  score: '9 · 9 · 8',
                  when: 'yesterday',
                },
                {
                  title: 'The bitter lesson, revisited (10y on)',
                  chan: 'DeepLearning.AI · 1:02:44',
                  segs: 14,
                  score: '8 · 8 · 7',
                  when: '3 days ago',
                },
                ...
                <div key={i} className="recent">
                  ...
                  <div className="recent__body">
                    ...
                    <div className="recent__meta">
                      {r.chan} · {r.segs} segments · top {r.score}
                    </div>
                  </div>
      ...
      <aside className="side">
        ...
        <div className="side__group">
          <div className="rail__row">
            ...
            <span className="val">gpt-4o-mini</span>
          </div>
          <div className="rail__row">
        ...
        <div className="side__group side__group--tips">
          <p className="tip">
            <span className="tip__k">⌘V</span>Paste URL anywhere to start.
          </p>
          <p className="tip">
            <span className="tip__k">⌘K</span>Open the command palette.
          </p>
          <p className="tip">
            <span className="tip__k">?</span>Keyboard shortcuts.
          </p>
        </div>
      </aside>
    </div>
