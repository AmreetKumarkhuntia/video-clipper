    ...
    <div className="screen-root" data-theme={theme}>
      ...
      <div className="shell">
        <aside className="rail rail--running">
          <h4 className="rail__h">
            Pipeline <span className="rail__h__chip">running</span>
          </h4>
          <Pipeline
            steps={[
              {
                ...
                t: '1.2s',
                state: 'done',
                detail: '12,481 chars · 22 chunks',
              },
              {
                name: 'LLM analysis',
                t: '11.4s',
                state: 'done',
                detail: '22 chunks · gpt-4o-mini · $0.0042',
              },
              {
                ...
                state: 'running',
                progress: 64,
                detail: 'snapping to sentence breaks',
              },
          ...
          <div className="log">
            <div className="log__line">
              <span className="log__t">14:02:11</span>
              <span className="log__msg log__msg--dim">→ fetch transcript</span>
            </div>
            <div className="log__line">
              <span className="log__t">14:02:12</span>
              <span className="log__msg"> done · 12,481 chars</span>
            </div>
            <div className="log__line">
              <span className="log__t">14:02:12</span>
              <span className="log__msg log__msg--dim">→ chunk · k=22</span>
            </div>
            <div className="log__line">
              <span className="log__t">14:02:14</span>
              <span className="log__msg log__msg--dim">→ score chunks · gpt-4o-mini</span>
            </div>
            <div className="log__line">
              <span className="log__t">14:02:25</span>
              <span className="log__msg"> done · 11.4s · $0.0042</span>
            </div>
            <div className="log__line">
              <span className="log__t">14:02:25</span>
              <span className="log__msg log__msg--dim">→ refine boundaries · 22 chunks</span>
            </div>
            <div className="log__line">
              <span className="log__t">14:02:31</span>
              <span className="log__msg log__msg--accent"> refining 14 / 22 …</span>
            </div>
          </div>
        </aside>
        ...
        <div className="main">
          ...
          <div className="timeline">
            <div className="timeline__head">
              <div>
                <span className="now">—:—</span> <span style={{ marginLeft: 8 }}>/ 30:23</span>
              </div>
        ...
        <aside className="side">
          ...
          <div className="side__group">
            <div className="rail__row">
              ...
              <span className="val">14:02:11</span>
            </div>
            <div className="rail__row">
              <span className="label">Elapsed</span>
              <span className="val val--accent">00:18</span>
            </div>
            <div className="rail__row">
              <span className="label">ETA</span>
              <span className="val">~10s</span>
            </div>
            <div className="rail__row">
              <span className="label">Tokens</span>
              <span className="val">14.2k in / 2.1k out</span>
            </div>
            <div className="rail__row">
              <span className="label">Cost</span>
              <span className="val">$0.0042</span>
            </div>
          </div>
          ...
          <div className="side__group side__group--status">
            <div className="status-line">
              <span className="dot dot--ok"></span>Transcript fetched
            </div>
            <div className="status-line">
              <span className="dot dot--ok"></span>22 chunks scored
            </div>
            <div className="status-line">
              <span className="dot dot--run"></span>Refining 14 / 22
            </div>
            <div className="status-line status-line--dim">
              <span className="dot"></span>Cutting clips (queued)
            </div>
          </div>

          <button className="vc-btn vc-btn--secondary" style={{ width: '100%' }}>
            Cancel run
          </button>
        </aside>
      </div>
