...
- Full Vitest suite: 619 tests passed. Server build, formatting, and web type-check passed. Both registry archives installed with lifecycle scripts disabled and passed package verification locally on macOS/Node 24; the Linux/Windows/Node 22 matrix is configured for CI and has not run locally.
