  ...
  <div className="screen-root" data-theme={theme}>
    ...
    <div className="settings-shell">
      <aside className="settings-nav">
        ...
        <button className="settings-nav__item is-active"><Icons.Sparkles size={16} />LLM provider</button>
        <button className="settings-nav__item"><Icons.Gauge size={16} />Scoring</button>
        <button className="settings-nav__item"><Icons.Crop size={16} />Output</button>
        <button className="settings-nav__item"><Icons.Captions size={16} />Captions</button>
        <button className="settings-nav__item"><Icons.Key size={16} />Auth &amp; cookies</button>
        <button className="settings-nav__item"><Icons.Database size={16} />Cache</button>
        <button className="settings-nav__item"><Icons.Terminal size={16} />Advanced</button>
        <div className="settings-nav__sep"></div>
        <button className="settings-nav__item"><Icons.Type size={16} />Appearance</button>
      </aside>

      <div className="settings-main">
        <div className="settings-head">
          <h2>LLM provider</h2>
          <p className="settings-head__sub">Which model scores transcript chunks and refines clip boundaries.</p>
        </div>
          ...
          <div className="provider-grid">
            {[
              ...
              <div key={p.k} className={`provider ${p.active ? "is-active" : ""}`}>
                ...
                {p.active ? <div className="provider__check"><Icons.Check size={14} /></div> : null}
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="settings-section">
          ...
          <div className="settings-form">
            <div className="vc-field">
              ...
              <input type="password" className="vc-input" defaultValue="sk-proj-••••••••••••••••••••••••" style={{ fontFamily: "var(--vc-font-mono)" }} />
              <span className="vc-help">Stored in <code>~/.config/video-clipper/keys</code></span>
            </div>
            <div className="vc-field">
        ...
        <section className="settings-section">
          ...
          <div className="settings-form settings-form--two">
            ...
            <div className="vc-field">
              ...
              <input type="text" className="vc-input" defaultValue="600 tokens" style={{ fontFamily: "var(--vc-font-mono)" }} />
            </div>
          </div>
          ...
          <div className="settings-toggles">
            <label className="toggle-row">
              <div>
                ...
                <div className="toggle-row__d">Boost segments with audible reactions (laughter, applause).</div>
              </div>
            ...
            <label className="toggle-row">
              <div>
                ...
                <div className="toggle-row__d">Second LLM pass to snap cuts to sentence breaks.</div>
              </div>
              <span className="vc-toggle"><input type="checkbox" defaultChecked /><span className="vc-toggle__track"></span><span className="vc-toggle__thumb"></span></span>
            </label>
            <label className="toggle-row">
              <div>
                ...
                <div className="toggle-row__d">Re-runs on the same URL skip the fetch + scoring step.</div>
              </div>
              <span className="vc-toggle"><input type="checkbox" defaultChecked /><span className="vc-toggle__track"></span><span className="vc-toggle__thumb"></span></span>
            </label>
          </div>
