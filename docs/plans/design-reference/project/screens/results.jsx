...
const ClipCard = ({ rank, start, end, dur, title, score, status = 'ready' }) => (
  <div className="clipcard">
    <div className="clipcard__thumb">
      ...
      <div className="clipcard__thumb-time">
        {start} → {end}
      </div>
      <div className="clipcard__thumb-play">
        <Icons.PlayFilled size={20} style={{ marginLeft: 2 }} />
      </div>
    ...
    <div className="clipcard__body">
      ...
      <div className="clipcard__actions">
        ...
        <button className="vc-btn vc-btn--ghost vc-btn--sm vc-btn--icon" aria-label="Download">
          <Icons.Download size={14} />
        </button>
        <button className="vc-btn vc-btn--ghost vc-btn--sm vc-btn--icon" aria-label="More">
  ...
  const allCut = SAMPLE_SEGMENTS.concat([
    {
      ...
      dur: '36s',
      title: 'Crisp summary of the framework',
    ...
    },
    {
      ...
      dur: '34s',
      title: 'Founder anecdote · the API rewrite',
      reason: 'narrative beat · transcript',
      score: 7,
    },
      ...
      <div className="shell">
        <aside className="rail">
          <h4 className="rail__h">
            Pipeline <span className="rail__h__chip rail__h__chip--ok">complete · 22.5s</span>
          </h4>
          <Pipeline
            steps={[
          ...
          <div className="rail__group">
            <div className="rail__row">
              ...
              <span className="val">22.5s</span>
            </div>
            <div className="rail__row">
              <span className="label">Tokens</span>
              <span className="val">22.4k</span>
            </div>
            <div className="rail__row">
            ...
            <div className="rail__row">
              ...
              <span className="val">8 · 4.6 MB</span>
            </div>
            <div className="rail__row">
              <span className="label">Cache</span>
              <span className="val">stored</span>
            </div>
          </div>
          ...
          <button
            ...
            style={{ width: '100%', marginTop: 6, justifyContent: 'flex-start' }}
          >
        ...
        <div className="main">
          <div className="vc-tabs" style={{ marginBottom: 20 }}>
            <button className="vc-tab is-active">
              Clips <span className="tab-count">8</span>
            </button>
            <button className="vc-tab">
              Segments <span className="tab-count">10</span>
            </button>
